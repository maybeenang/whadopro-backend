...
class NotifService(object):
    ...
    def SendNotif(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/notif.NotifService/SendNotif',
    ...
    def GetNotifs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/notif.NotifService/GetNotifs',
    ...
    def DeleteNotif(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/notif.NotifService/DeleteNotif',
